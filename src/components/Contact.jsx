            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8 md:p-12">
                    <div className="text-center mb-10">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Zapojte se do diskuze</h2>
                        <p className="text-gray-400">
                            Jste připraveni utvářet budoucnost AI v kreativních odvětvích? Ozvěte se nám.
                        </p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label htmlFor="name" className="text-sm font-medium text-gray-300">Jméno</label>
                                <input
                                    type="text"
                                    id="name"
                        ...
                        <div className="space-y-2">
                            <label htmlFor="message" className="text-sm font-medium text-gray-300">Zpráva</label>
                            <textarea
                                id="message"
                                rows="4"
                                ...
                                placeholder="Povězte nám o svém zájmu..."
                            ></textarea>
                        </div>
